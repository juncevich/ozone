 ...
 * (non-synchronized version of org.apache.hadoop.metrics2.lib.ReadWriteLockMutableRate)
 */
public class ReadWriteLockMutableRate extends MutableStat {
  ...
  public ReadWriteLockMutableRate(String name) {
    this(name, name, false);
  }

  public ReadWriteLockMutableRate(String name, String description) {
    this(name, description, false);
  }

  public ReadWriteLockMutableRate(String name, String description, boolean extended) {
